...
function decisionSnapshot(canonicalFindings) {
    return {
        schemaVersion: 5,
        auditId: AUDIT_ID,
        decisionId: `ztd-${sha256("decision")}`,
        canonicalFindings,
    };
}
...
test("minimal edge break targets one evidence-bound edge and clears the known chain", () => {
    const findingId = `ztf-${"1".repeat(64)}`;
